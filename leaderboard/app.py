...
DGEB Leaderboard. To submit, refer to the <a href="https://github.com/TattaBio/DGEB?tab=readme-ov-file#leaderboard" target="_blank" style="text-decoration: underline">DGEB GitHub repository</a> Refer to the <a href="https://www.biorxiv.org/content/10.1101/2024.07.10.602933v1" target="_blank" style="text-decoration: underline">DGEB paper</a> for details on metrics, tasks, and models.
</div>
"""
    )
